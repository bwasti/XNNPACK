  ...
  do {
    ...
    do {
      ...
      while (k + 8 * sizeof(int8_t) <= kc) {
        ...
        int8x8_t va8x01234567 = vld1_s8(a8); a8 += 8;
        int8x8_t va9x01234567 = vld1_s8(a9); a9 += 8;
        int8x8_t va10x01234567 = vld1_s8(a10); a10 += 8;
        int8x8_t va11x01234567 = vld1_s8(a11); a11 += 8;
